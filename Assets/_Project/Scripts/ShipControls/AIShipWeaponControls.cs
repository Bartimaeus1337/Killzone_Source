...
public class AIShipWeaponControls : WeaponControlsBase
{
    ...
    bool CanFirePrimary()
    {
        ...
        RaycastHit hit;
        var canHitTarget = Physics.Raycast(_transform.position, _transform.forward, out hit, _attackRange * 0.5f, _layerMask);
        //if (canHitTarget)
        //{
    ...
    bool CanFireSecondary()
    {
        ...
        return false; // TODO: Add secondary weapons later on
    }
